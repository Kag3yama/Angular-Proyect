...
export class FormularioReactivoComponent {
  ...
  constructor(){
    ...
    let controles: any = {
      correo: new FormControl('matiasolivieri@gmail.com', [Validators.required, Validators.pattern(regexCorreo)]),
      contrasena: new FormControl('123', [Validators.required, Validators.minLength(6)]),
  ...
  login(){
    ...
    if(this.formularioLogin.controls['correo'].errors?.['pattern']) {
      console.log("Hubo un error en el formato del correo electronico")
    }
